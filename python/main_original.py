...
Usage:
    ...
    python main.py delete_define_libraries_table <envname> <dbname>
    python main.py delete_define_libraries_table azure dev
    python main.py load_pg_libraries_table <envname> <dbname>
    python main.py load_pg_libraries_table azure dev
    python main.py vector_search_similar_libraries <envname> <dbname> <libname>
    python main.py vector_search_similar_libraries azure dev flask
    python main.py vector_search_words <envname> <dbname> <word1> <word2> <word3> ...
    python main.py vector_search_words azure dev asynchronous web framework with pydantic
Options:
